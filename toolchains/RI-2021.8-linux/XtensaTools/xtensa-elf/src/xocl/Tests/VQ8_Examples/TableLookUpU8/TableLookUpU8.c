...
#define XI_LUT512U8N2 XI_LUT8NX8U
...
XI_ERR_TYPE xiLUT512_U8(const xi_pArray src, xi_pArray dst,
                        const uint8_t *lut512) {
  ...
  {
    xb_vec2Nx8U *vplut = (xb_vec2Nx8U *)lut512;
  ...
  for (; x < width - 2 * XCHAL_IVPN_SIMD_WIDTH;
    ...
    for (int y = 0; y < height; ++y) {
      ...
      xb_vec2Nx8U vdst0;
      XI_LUT512U8N2(vsrc0, vdst0, lut0, lut1, lut2, lut3);
      xb_vec2Nx8U vdst1;
      XI_LUT512U8N2(vsrc1, vdst1, lut0, lut1, lut2, lut3);
  ...
  if (x < width) {
    ...
    for (int y = 0; y < height; ++y) {
      ...
      xb_vec2Nx8U vdst;
      XI_LUT512U8N2(vsrc, vdst, lut0, lut1, lut2, lut3);
