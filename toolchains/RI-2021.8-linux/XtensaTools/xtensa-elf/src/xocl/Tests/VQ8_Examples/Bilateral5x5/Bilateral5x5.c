...
#define IVP_SIMD_WIDTH (XCHAL_VISION_SIMD16)
#define ACC_SHIFT      8
...
void xvFilter5x5Bilateral(xi_pTile src, xi_pTile dst, void *tempDiv,
  ...
  vecSeq = IVP_SEQNX16U();
  vecSeq1 = vecSeq >> 1;
  xb_vecN_2x32Uv vec1 = (XCHAL_VISION_SIMD16/2) << 16;
...
C0	C1	C2	C1	C0
  ...
  for (ix = 0; ix < xIterations; ix++) {
    ...
    for (iy = 0; iy < height; iy++) {
      ...
      IVP_SVNX16U_IP(vecCoeffSumL, pvecTemp, XCHAL_VISION_SIMD16*2);
      IVP_SVNX16U_IP(vecCoeffSumH, pvecTemp, XCHAL_VISION_SIMD16*2);
      ...
      IVP_SVN_2X32_IP(vecResultLL, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_SVN_2X32_IP(vecResultLH, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_SVN_2X32_IP(vecResultHL, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_SVN_2X32_IP(vecResultHH, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
    }
...
#pragma no_reorder
    ...
    for (iy = 0; iy < height; iy++) {
      ...
      IVP_LVNX16U_IP(vecCoeffSumL, pvecTemp, XCHAL_VISION_SIMD16*2);
      xb_vecNx16 vecCoeffSumH;
      IVP_LVNX16U_IP(vecCoeffSumH, pvecTemp, XCHAL_VISION_SIMD16*2);
      vecCoeffSumL += IVP_CVT16U2NX24L(daccCoeffSum);
      vecCoeffSumH += IVP_CVT16U2NX24H(daccCoeffSum);

      xb_vecN_2x32v vecResultLL, vecResultLH, vecResultHL, vecResultHH;
      IVP_LVN_2X32_IP(vecResultLL, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_LVN_2X32_IP(vecResultLH, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_LVN_2X32_IP(vecResultHL, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      IVP_LVN_2X32_IP(vecResultHH, (xb_vecN_2x32v *)pvecTemp, 
                      XCHAL_VISION_SIMD16*2);
      vecResultLL += IVP_CVT32S2NX24LL(daccFilt);
      vecResultLH += IVP_CVT32S2NX24LH(daccFilt);
      vecResultHL += IVP_CVT32S2NX24HL(daccFilt);
      ...
      IVP_SVNX8U_IP(vecResultL, pvecResult, XCHAL_VISION_SIMD16);
      IVP_SVNX8U_XP(vecResultH, pvecResult, widthExp - XCHAL_VISION_SIMD16);
    }
  }
}
