                          ...
                          __local float32* restrict local_B)
{
  ...
  for (ib = i, ic = 0; ib < i + 64; ib += 4, ic += 8) {
    float32 local_C_tmp0 = 0;
    float32 local_C_tmp1 = 0;
    float32 local_C_tmp2 = 0;
    float32 local_C_tmp3 = 0;
    float32 local_C_tmp4 = 0;
    float32 local_C_tmp5 = 0;
    float32 local_C_tmp6 = 0;
    float32 local_C_tmp7 = 0;
