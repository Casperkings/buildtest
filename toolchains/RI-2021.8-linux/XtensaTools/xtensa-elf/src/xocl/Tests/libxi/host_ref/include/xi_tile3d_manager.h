...
#define XI_FRAME3D_GET_DIM1_PITCH_IN_BYTES(x)                                  \
  ((x)->dim1Pitch * ((x)->pixelRes / 8 + ((x)->pixelRes & 7 != 0)))
...
#define XI_FRAME3D_GET_DIM2_PITCH_IN_BYTES(x)                                  \
  ((x)->dim2Pitch * ((x)->pixelRes / 8 + ((x)->pixelRes & 7 != 0)))
...
#define XI_TILE3D_SET_FRAME_PTR(pTile3D, ptrFrame)                             \
  (pTile3D)->pFrame = ((xi_pFrame3D)(ptrFrame))

#define XI_TILE3D_CHECK_STATUS_FLAGS_DMA_ONGOING                               \
  XI_TILE_CHECK_STATUS_FLAGS_DMA_ONGOING
...
#define SETUP_TILE3D(type, pTile, pBuf, pFrame, bufSize, dim1Size, dim2Size,   \
                     dim3Size, dim1Pitch, dim2Pitch, dim1Edge1, dim1Edge2,     \
                     dim2Edge1, dim2Edge2, dim3Edge1, dim3Edge2, dim1Loc,      \
                     dim2Loc, dim3Loc, dataOrder, alignType)                   \
  {                                                                            \
    ...
    XI_TILE3D_SET_DATA_PTR(                                                    \
        pTile, edgePtr + ((dim3Edge1) * (dim2Pitch) +                          \
                          (dim2Edge1) * (dim1Pitch) + (dim1Edge1)) *           \
                             XI_TILE3D_GET_ELEMENT_SIZE(pTile));               \
...
#define SETUP_FRAME3D(pFrame, pFrameBuffer, bufSize, dim1Size, dim2Size,       \
                      dim3Size, dim1Pitch, dim2Pitch, dim1Edge1, dim1Edge2,    \
                      dim2Edge1, dim2Edge2, dim3Edge1, dim3Edge2, pixRes,      \
                      pixPackFormat, paddingType, dataOrder)                   \
  {                                                                            \
    ...
    XI_FRAME3D_SET_DATA_PTR(                                                   \
        pFrame, pFrameBuffer + ((dim3Edge1) * (dim2Pitch) +                    \
                                (dim2Edge1) * (dim1Pitch) + (dim1Edge1)) *     \
                                   pixRes);                                    \
...
#define XI_TILE3D_UPDATE_DIMENSIONS(pTile, dim1Loc, dim2Loc, dim3Loc,          \
                                    dim1Size, dim2Size, dim3Size, dim1Pitch,   \
                                    dim2Pitch)                                 \
  {                                                                            \
    XI_TILE3D_SET_DIM1_COORD(pTile, dim1Loc);                                  \
    XI_TILE3D_SET_DIM2_COORD(pTile, dim2Loc);                                  \
...
#define XI_TILE4D_U8                                                           \
  (XI_U8 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
#define XI_TILE4D_S8                                                           \
  (XI_S8 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
#define XI_TILE4D_U16                                                          \
  (XI_U16 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
#define XI_TILE4D_S16                                                          \
  (XI_S16 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
#define XI_TILE4D_U32                                                          \
  (XI_U32 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
#define XI_TILE4D_S32                                                          \
  (XI_S32 | XI_TYPE_TILE4D_BIT | XI_TYPE_TILE3D_BIT | XI_TYPE_TILE_BIT)
...
#define XI_TILE4D_SET_FRAME_PTR(pTile4D, ptrFrame)                             \
  (pTile4D)->pFrame = ((xi_pFrame4D)(ptrFrame))

#define XI_TILE4D_CHECK_STATUS_FLAGS_DMA_ONGOING                               \
  XI_TILE_CHECK_STATUS_FLAGS_DMA_ONGOING
#define XI_TILE4D_CHECK_STATUS_FLAGS_EDGE_PADDING_NEEDED                       \
  XI_TILE_CHECK_STATUS_FLAGS_EDGE_PADDING_NEEDED
...
#define SETUP_TILE4D(type, pTile, pBuf, pFrame, bufSize, dim1Size, dim2Size,   \
                     dim3Size, dim4Size, dim1Pitch, dim2Pitch, dim3Pitch,      \
                     dim1Edge1, dim1Edge2, dim2Edge1, dim2Edge2, dim3Edge1,    \
                     dim3Edge2, dim1Loc, dim2Loc, dim3Loc, dim4Loc, dataOrder, \
                     alignType)                                                \
  {                                                                            \
...
#define SETUP_FRAME4D(pFrame, pFrameBuffer, bufSize, dim1Size, dim2Size,       \
                      dim3Size, dim4Size, dim1Pitch, dim2Pitch, dim3Pitch,     \
                      dim1Edge1, dim1Edge2, dim2Edge1, dim2Edge2, dim3Edge1,   \
                      dim3Edge2, pixRes, pixPackFormat, paddingType,           \
                      dataOrder)                                               \
  {                                                                            \
...
#define XI_TILE4D_UPDATE_DIMENSIONS(pTile, dim1Loc, dim2Loc, dim3Loc, dim4Loc, \
                                    dim1Size, dim2Size, dim3Size, dim4Size,    \
