...
void launch_ocl_BoxFilter3x3(uint8_t *Src, uint32_t SrcPitch, uint8_t *Dst,
  ...
  const char *progSource = loadKernel("BoxFilter3x3.cl");
  cl_program program =
...
int main() {
  ...
  launch_ocl_BoxFilter3x3(gsrc, srcStride, gdst, dstWidth, srcWidth, srcHeight,
                      dstWidth, dstHeight);
