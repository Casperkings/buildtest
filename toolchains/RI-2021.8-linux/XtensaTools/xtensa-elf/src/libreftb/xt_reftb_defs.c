...
// Define STL INFO location
#ifndef TB_STL_INFO_LOCATION 
#define TB_STL_INFO_LOCATION (XSHAL_STL_INFO_LOCATION + TB_STL_INFO_OFFSET)
#endif
...
volatile weak unsigned int *_reftb_stl_info_location  = (unsigned int*) TB_STL_INFO_LOCATION;
