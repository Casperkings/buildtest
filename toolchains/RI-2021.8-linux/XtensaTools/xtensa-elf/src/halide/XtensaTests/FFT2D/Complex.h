...
struct ComplexExpr {
    ...
    ComplexExpr() : x(0), y(0) {}
    ComplexExpr(int32_t x, int32_t y) : x(x), y(y) {}
    ...
    ComplexExpr(Halide::Expr x, Halide::Expr y = 0) : x(x), y(y) {}
    ...
    ComplexExpr &operator=(ComplexExpr c) {
      this->x = c.x;
      this->y = c.y;
      return *this;
    }
    
    ComplexExpr operator>>(int32_t a) {
      ComplexExpr temp;
      temp.x = this->x >> a;
      temp.y = this->y >> a;
      return temp;
...
inline Halide::Expr im(Halide::Expr x) { return 0; }
...
inline ComplexExpr select(Halide::Expr c1, ComplexExpr t1,
                          Halide::Expr c2, ComplexExpr t2,
                          Halide::Expr c3, ComplexExpr t3,
                                           ComplexExpr f) {
    return ComplexExpr(Halide::select(c1, re(t1), c2, re(t2), c3, re(t3), re(f)),
                       Halide::select(c1, im(t1), c2, im(t2), c3, im(t3), im(f)));
}
template <typename T>
