...
public:
    ...
    Stage &dma_copy(VarOrRVar var);
    Stage &mul_hi(VarOrRVar var);
...
public:
    ...
    */
    ...
    /* Experimental: Load from global memory into shared memory using DMA */
    Func &dma_copy(VarOrRVar var);
    Func & mul_hi(VarOrRVar var);
