...
inline Expr mul_hi(Expr a, Expr b) {
    user_assert(a.defined() && b.defined()) << "count leading zeros of undefined Expr\n";
    Type t = a.type();
    return Internal::Call::make(t, Internal::Call::mul_hi,
                                {std::move(a), std::move(b)}, Internal::Call::PureIntrinsic);
}
