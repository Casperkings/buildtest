...
#ifndef IN_LIBGCC2
/* for now in libgcc this parameter is fixed to float_round_nearest_even */
...
extern float32 roundAndPackFloat32( flag zSign, int16 zExp, bits32 zSig );
...
#endif /* LIBGCC2_INCLUDE_COMMON_F32 */
...
#endif /* LIBGCC2_INCLUDE_COMMON_F64 */
...
int32 float32_to_int32( float32 a )
{
    ...
    if ( 0 <= shiftCount ) {
        ...
        if ( aSigExtra ) float_raise( float_flag_inexact );
        roundingMode = float_rounding_mode;
...
float32 float32_round_to_int( float32 a )
{
    ...
    z &= ~ roundBitsMask;
    if ( z != a ) float_raise ( float_flag_inexact );
    return z;
...
#if !defined(IN_LIBGCC2) || defined(L_divsf3)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_divsf3) */
...
#if !defined(IN_LIBGCC2) || defined(L_modsf3)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_modsf3) */
...
#if !defined(IN_LIBGCC2) || defined(L_sqrtsf2)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_sqrtsf2) */
...
#if !defined(IN_LIBGCC2) || defined(L_divdf3)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_divdf3) */
...
#if !defined(IN_LIBGCC2) || defined(L_moddf3)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_moddf3) */
...
#if !defined(IN_LIBGCC2) || defined(L_sqrtdf2)
...
#endif /* !defined(IN_LIBGCC2) || defined(L_sqrtdf2) */
