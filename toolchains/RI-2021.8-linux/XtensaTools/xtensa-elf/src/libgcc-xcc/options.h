...
extern int warn_unused_tie_intrinsic_result;
...
extern int flag_pcc_struct_return;
extern int flag_regmove;
extern int flag_remove_unused_functions;
...
enum opt_code
{
  ...
  OPT_Wunused_tie_intrinsic_result,          /* -Wunused-tie-intrinsic-result */
  ...
  OPT_fremove_unused_functions,              /* -fremove-unused-functions */
