...
struct SYSTEMC_API sc_bind_proxy
{
    sc_interface* iface;
    sc_port_base* port;
...
extern SYSTEMC_API const sc_bind_proxy SC_BIND_PROXY_NIL;
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_event_finder*>;
template class SYSTEMC_API std::vector   <sc_event_finder*>;
template class SYSTEMC_API sc_plist_iter<sc_module*>;
template class SYSTEMC_API sc_plist     <sc_module*>;
#endif

extern SYSTEMC_API sc_module* sc_module_dynalloc(sc_module*);
...
#define SC_MODULE(user_module_name)                                           \
    struct SYSTEMC_API user_module_name : ::sc_core::sc_module
