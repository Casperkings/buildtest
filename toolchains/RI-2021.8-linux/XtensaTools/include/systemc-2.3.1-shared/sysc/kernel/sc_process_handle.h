...
// TODO: Ric why don't these need SYSTEMC_API like in sc_signed.h
bool 
...
//=============================================================================
class sc_simcontext;
class SYSTEMC_API sc_process_handle {
    typedef sc_process_handle this_type;

    // TODO: Ric: Does friend operator need SYSTEMC_API (here and similar elsewheres)?
    // TODO: Ric: Does        operator need SYSTEMC_API?
