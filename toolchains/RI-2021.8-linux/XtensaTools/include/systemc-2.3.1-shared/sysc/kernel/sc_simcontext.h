...
struct SYSTEMC_API sc_curr_proc_info
{
...
extern SYSTEMC_API void sc_set_stop_mode( sc_stop_mode mode );
extern SYSTEMC_API sc_stop_mode sc_get_stop_mode();

#ifdef _MSC_VER
template class SYSTEMC_API sc_ppq<sc_event_timed*>;
#endif
...
extern SYSTEMC_API void sc_start();
extern SYSTEMC_API void sc_start( const sc_time& duration, 
...
extern SYSTEMC_API void sc_stop();
...
SYSTEMC_API void    sc_start( const sc_time&, sc_starvation_policy );
            bool    sc_start_of_simulation_invoked();
SYSTEMC_API void    sc_set_time_resolution( double, sc_time_unit );
SYSTEMC_API sc_time sc_get_time_resolution();
SYSTEMC_API void    sc_set_default_time_unit( double, sc_time_unit );
SYSTEMC_API sc_time sc_get_default_time_unit();
            bool    sc_pending_activity_at_current_time( const sc_simcontext* );
            bool    sc_pending_activity_at_future_time( const sc_simcontext* );
SYSTEMC_API sc_time sc_time_to_pending_activity( const sc_simcontext* );
...
class SYSTEMC_API sc_simcontext
{
    ...
    friend SYSTEMC_API void sc_start( const sc_time&, sc_starvation_policy );
    friend             bool sc_start_of_simulation_invoked();
    friend SYSTEMC_API void sc_thread_cor_fn(void*);
    friend SYSTEMC_API sc_time sc_time_to_pending_activity( const sc_simcontext* );
...
public:
    ...
    friend SYSTEMC_API void    sc_set_time_resolution( double, sc_time_unit );
    friend SYSTEMC_API sc_time sc_get_time_resolution();
    friend SYSTEMC_API void    sc_set_default_time_unit( double, sc_time_unit );
    friend SYSTEMC_API sc_time sc_get_default_time_unit();
...
#if 1
extern SYSTEMC_API sc_simcontext* sc_curr_simcontext;
extern SYSTEMC_API sc_simcontext* sc_default_global_context;
...
#else
    extern SYSTEMC_API sc_simcontext* sc_get_curr_simcontext();
#endif // 0
...
sc_simcontext::add_delta_event( sc_event* e )
{
    ...
    return ( (int) m_delta_events.size() - 1 );
}
...
class sc_process_handle;
SYSTEMC_API sc_process_handle sc_get_current_process_handle();
...
extern SYSTEMC_API sc_process_b* sc_get_curr_process_handle();
...
extern SYSTEMC_API void sc_initialize();

extern SYSTEMC_API const sc_time& sc_max_time();    // Get maximum time value.
extern SYSTEMC_API const sc_time& sc_time_stamp();  // Current simulation time.
extern SYSTEMC_API double sc_simulation_time();     // Current time in default time units.
...
extern SYSTEMC_API sc_event* sc_find_event( const char* name );

extern SYSTEMC_API sc_object* sc_find_object( const char* name );
...
SYSTEMC_API bool sc_is_unwinding();
...
extern SYSTEMC_API bool sc_allow_process_control_corners;
