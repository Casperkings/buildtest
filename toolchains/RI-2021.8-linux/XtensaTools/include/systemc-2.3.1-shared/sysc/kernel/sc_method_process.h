...
SYSTEMC_API void sc_method_cor_fn( void* );
SYSTEMC_API void sc_cmethod_cor_fn( void* );
SYSTEMC_API void sc_set_stack_size( sc_method_handle, std::size_t );
class sc_event;
class sc_module;
...
SYSTEMC_API void next_trigger( sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_event&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_event_or_list&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_event_and_list&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_time&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_time&, const sc_event&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_time&, const sc_event_or_list&, sc_simcontext* );
SYSTEMC_API void next_trigger( const sc_time&, const sc_event_and_list&, sc_simcontext* );
...
//
//==============================================================================
class SYSTEMC_API sc_method_process : public sc_process_b {
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_method_process*>;
template class SYSTEMC_API std::vector   <sc_method_process*>;
#endif
