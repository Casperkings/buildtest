...
class SYSTEMC_API sc_attr_base
{
public:
...
template class SYSTEMC_API ::std::allocator<sc_attr_base*>;
template class SYSTEMC_API ::std::vector   <sc_attr_base*>;
SC_PRAGMA_WARNING(pop)
// TODO: Ric is this needed anymore?  It doesn't compile on MS Windows.  Is there something else that SHOULD go here now?
//template class SYSTEMC_API sc_pvector<sc_attr_base*>;
#endif
...
class SYSTEMC_API sc_attr_cltn
{
public:
