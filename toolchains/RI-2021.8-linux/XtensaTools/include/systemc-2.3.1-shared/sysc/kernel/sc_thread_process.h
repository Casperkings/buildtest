...
SYSTEMC_API sc_cor* get_cor_pointer( sc_process_b* process_p );
SYSTEMC_API void sc_set_stack_size( sc_thread_handle thread_h, std::size_t size );
SYSTEMC_API void wait( sc_simcontext* );
SYSTEMC_API void wait( const sc_event&, sc_simcontext* );
SYSTEMC_API void wait( const sc_event_or_list&, sc_simcontext* );
SYSTEMC_API void wait( const sc_event_and_list&, sc_simcontext* );
SYSTEMC_API void wait( const sc_time&, sc_simcontext* );
SYSTEMC_API void wait( const sc_time&, const sc_event&, sc_simcontext* );
SYSTEMC_API void wait( const sc_time&, const sc_event_or_list&, sc_simcontext* );
SYSTEMC_API void wait( const sc_time&, const sc_event_and_list&, sc_simcontext* );

//==============================================================================
// sc_thread_process -
//
//==============================================================================
class SYSTEMC_API sc_thread_process : public sc_process_b {
    ...
    // TODO: Ric why don't these need SYSTEMC_API?
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_thread_process*>;
template class SYSTEMC_API std::vector   <sc_thread_process*>;
#endif
