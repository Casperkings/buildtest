...
// friend function declarations
    SYSTEMC_API int sc_notify_time_compare( const void*, const void* );
...
class SYSTEMC_API sc_event_list
{
...
class SYSTEMC_API sc_event_and_list
...
class SYSTEMC_API sc_event_or_list
: public sc_event_list
{
    friend class sc_event;
...
template class SYSTEMC_API std::allocator<sc_event*>;
template class SYSTEMC_API std::vector   <sc_event*>;
template class SYSTEMC_API std::allocator<const sc_event*>;
template class SYSTEMC_API std::vector   <const sc_event*>;
SC_PRAGMA_WARNING(pop)
#endif

extern SYSTEMC_API sc_event sc_non_event; // Event that never happens.
...
class SYSTEMC_API sc_event_timed
{
    friend class sc_event;
    friend class sc_simcontext;

    friend SYSTEMC_API int sc_notify_time_compare( const void*, const void* );
...
extern SYSTEMC_API void notify( sc_event& e );
extern SYSTEMC_API void notify( const sc_time& t, sc_event& e );
extern SYSTEMC_API void notify( double v, sc_time_unit tu, sc_event& e );
