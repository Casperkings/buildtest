...
SYSTEMC_API const char* sc_gen_unique_name( const char*, bool preserve_first );
SYSTEMC_API sc_process_handle sc_get_current_process_handle();
SYSTEMC_API void sc_thread_cor_fn( void* arg );
SYSTEMC_API bool timed_out( sc_simcontext* );

extern SYSTEMC_API bool sc_allow_process_control_corners; // see sc_simcontext.cpp.
...
class SYSTEMC_API sc_process_host 
{
  public:
    sc_process_host() {}
...
class SYSTEMC_API sc_process_monitor {
  public:
    enum {
        spm_exit = 0
    };
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_process_monitor*>;
template class SYSTEMC_API std::vector   <sc_process_monitor*>;
#endif
...
// COMPILER NOT DOES SUPPORT CAST TO void (sc_process_host::*)() from (T::*)():
    ...
    class SYSTEMC_API sc_process_call_base {
      public:
    ...
    extern SYSTEMC_API sc_process_call_base sc_process_defunct;
...
extern SYSTEMC_API void sc_set_stack_size( sc_thread_handle, std::size_t );
...
//==============================================================================
class SYSTEMC_API sc_throw_it_helper {
  public:
...
//       
//==============================================================================
class SYSTEMC_API sc_process_b : public sc_object { 
    ...
    friend SYSTEMC_API const char* sc_gen_unique_name( const char*, bool preserve_first );
    friend SYSTEMC_API sc_process_handle sc_get_current_process_handle();
    friend SYSTEMC_API void sc_thread_cor_fn( void* arg );
    friend SYSTEMC_API bool timed_out( sc_simcontext* );
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_process_b*>;
SC_PRAGMA_WARNING(push)
SC_PRAGMA_WARNING(disable:4251)
SC_PRAGMA_WARNING(disable:4275)
template class SYSTEMC_API std::vector   <sc_process_b*>;
SC_PRAGMA_WARNING(pop)
#endif
