...
// friend operator declarations
    ...
    SYSTEMC_API const sc_time operator + ( const sc_time&, const sc_time& );
    SYSTEMC_API const sc_time operator - ( const sc_time&, const sc_time& );
    SYSTEMC_API const sc_time operator * ( const sc_time&, double );
    SYSTEMC_API const sc_time operator * ( double, const sc_time& );
    SYSTEMC_API const sc_time operator / ( const sc_time&, double );
    SYSTEMC_API double        operator / ( const sc_time&, const sc_time& );
...
public:
    ...
    friend SYSTEMC_API const sc_time operator + ( const sc_time&, const sc_time& );
    friend SYSTEMC_API const sc_time operator - ( const sc_time&, const sc_time& );
    ...
    friend SYSTEMC_API const sc_time operator * ( const sc_time&, double );
    friend SYSTEMC_API const sc_time operator * ( double, const sc_time& );
    friend SYSTEMC_API const sc_time operator / ( const sc_time&, double );
    friend SYSTEMC_API double        operator / ( const sc_time&, const sc_time& );
    friend SYSTEMC_API const sc_time operator % ( const sc_time&, const sc_time& );
...
struct SYSTEMC_API sc_time_params
{
...
extern SYSTEMC_API const sc_time SC_ZERO_TIME;


// functions for accessing the time resolution and default time unit

extern SYSTEMC_API void    sc_set_time_resolution( double, sc_time_unit );
extern SYSTEMC_API sc_time sc_get_time_resolution();

extern SYSTEMC_API void    sc_set_default_time_unit( double, sc_time_unit );
extern SYSTEMC_API sc_time sc_get_default_time_unit();
