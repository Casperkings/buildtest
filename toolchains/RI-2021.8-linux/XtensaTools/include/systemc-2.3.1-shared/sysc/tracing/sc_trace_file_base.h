...
class SYSTEMC_API sc_trace_file_base
...
SYSTEMC_API void double_to_special_int64( double in, unsigned* high, unsigned* low );

// obtain formatted time string
SYSTEMC_API std::string localtime_string();
