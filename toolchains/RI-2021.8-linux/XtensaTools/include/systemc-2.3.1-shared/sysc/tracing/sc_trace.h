...
class SYSTEMC_API sc_trace_file
{
...
template class SYSTEMC_API std::allocator<sc_trace_file*>;
template class SYSTEMC_API std::vector   <sc_trace_file*>;
...
SYSTEMC_API void sc_trace( sc_trace_file* tf,
...
extern SYSTEMC_API void sc_trace( sc_trace_file* tf,
		      const void* object,
		      const std::string& name );
...
SYSTEMC_API void tprintf( sc_trace_file* tf,  const char* format, ... );

// ----------------------------------------------------------------------------
// Create VCD file
extern SYSTEMC_API sc_trace_file *sc_create_vcd_trace_file(const char* name);
extern SYSTEMC_API void sc_close_vcd_trace_file( sc_trace_file* tf );


// ----------------------------------------------------------------------------
// Create WIF file
extern SYSTEMC_API sc_trace_file *sc_create_wif_trace_file(const char *name);
extern SYSTEMC_API void sc_close_wif_trace_file( sc_trace_file* tf );
