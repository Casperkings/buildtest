...
extern SYSTEMC_API void sc_deprecated_get_data_ref();
extern SYSTEMC_API void sc_deprecated_get_new_value();
extern SYSTEMC_API void sc_deprecated_trace();
extern SYSTEMC_API sc_event * sc_lazy_kernel_event( sc_event**, const char* name );
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_signal<bool,SC_ONE_WRITER>;
#endif
