...
class SYSTEMC_API sc_export_base : public sc_object
{
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_export_base*>;
template class SYSTEMC_API std::vector   <sc_export_base*>;
#endif
...
class SYSTEMC_API sc_export_registry
{
