...
extern SYSTEMC_API void sc_deprecated_add_trace();

struct SYSTEMC_API sc_trace_params
{
    sc_trace_file*        tf;
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_trace_params*>;
template class SYSTEMC_API std::vector   <sc_trace_params*>;
#endif
...
SC_PRAGMA_WARNING(disable:4251)
template <>
class SYSTEMC_API sc_in<sc_dt::sc_logic>
...
SC_PRAGMA_WARNING(disable:4251)
template <>
class SYSTEMC_API sc_inout<bool> : 
...
SC_PRAGMA_WARNING(disable:4251)
template <>
class SYSTEMC_API sc_inout<sc_dt::sc_logic>
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_event_finder_t<sc_signal_in_if<sc_dt::sc_logic> >;
template class SYSTEMC_API sc_event_finder_t<sc_signal_in_if<bool> >;
#endif
