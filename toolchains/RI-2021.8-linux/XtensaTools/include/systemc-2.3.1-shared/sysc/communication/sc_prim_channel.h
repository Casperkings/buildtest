...
class SYSTEMC_API sc_prim_channel
: public sc_object
{
...
#ifdef _MSC_VER
template class SYSTEMC_API std::allocator<sc_prim_channel*>;
template class SYSTEMC_API std::vector   <sc_prim_channel*>;
#endif
...
class SYSTEMC_API sc_prim_channel_registry
{
...
public:
    ...
    int size() const
        { return (int)m_prim_channel_vec.size(); }
