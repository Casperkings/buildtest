...
SYSTEMC_API const std::string sc_report_compose_message( const sc_report& );
...
class SYSTEMC_API sc_report : public std::exception
{
    friend class sc_report_handler;
    friend SYSTEMC_API sc_report* sc_handle_exception();
...
extern SYSTEMC_API const char SC_ID_UNKNOWN_ERROR_[];
extern SYSTEMC_API const char SC_ID_WITHOUT_MESSAGE_[];
extern SYSTEMC_API const char SC_ID_NOT_IMPLEMENTED_[];
extern SYSTEMC_API const char SC_ID_INTERNAL_ERROR_[];
extern SYSTEMC_API const char SC_ID_ASSERTION_FAILED_[];
extern SYSTEMC_API const char SC_ID_OUT_OF_BOUNDS_[];

// backward compatibility with 2.0+
extern SYSTEMC_API const char SC_ID_REGISTER_ID_FAILED_[];
