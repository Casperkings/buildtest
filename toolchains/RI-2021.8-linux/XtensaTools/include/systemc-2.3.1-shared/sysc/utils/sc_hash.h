...
extern SYSTEMC_API unsigned default_int_hash_fn(const void*);
extern SYSTEMC_API unsigned default_ptr_hash_fn(const void*);
extern SYSTEMC_API unsigned default_str_hash_fn(const void*);
...
extern SYSTEMC_API const double PHASH_DEFAULT_GROW_FACTOR;
const bool   PHASH_DEFAULT_REORDER_FLAG    = true;

class SYSTEMC_API sc_phash_base {
...
class SYSTEMC_API sc_phash_base_iter {
protected:
    sc_phash_base*  table;
    sc_phash_elem*  entry;
    sc_phash_elem*  next;
...
extern SYSTEMC_API int sc_strhash_cmp( const void*, const void* );
extern SYSTEMC_API void sc_strhash_kfree(void*);
extern SYSTEMC_API void* sc_strhash_kdup(const void*);
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_strhash_iter<int*>;
#endif
