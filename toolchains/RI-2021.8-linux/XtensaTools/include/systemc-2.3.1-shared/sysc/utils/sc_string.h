...
SYSTEMC_API sc_string_old operator + ( const char* s, const sc_string_old& t );
...
class SYSTEMC_API sc_string_old
{
...
public:
    ...
    friend SYSTEMC_API sc_string_old operator + ( const char* s, const sc_string_old& t );
