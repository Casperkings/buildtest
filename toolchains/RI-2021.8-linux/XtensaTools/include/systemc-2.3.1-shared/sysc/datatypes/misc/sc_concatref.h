...
namespace sc_core {
    extern SYSTEMC_API sc_byte_heap sc_temp_heap; // Temporary storage.
} // namespace sc_core
...
class SYSTEMC_API sc_concatref : public sc_generic_base<sc_concatref>, public sc_value_base
{
public:
    friend class SYSTEMC_API sc_core::sc_vpool<sc_concatref>;
...
class SYSTEMC_API sc_concat_bool : public sc_value_base
{
  protected:

#if defined(_MSC_VER) && (_MSC_VER < 1600)
    template class SYSTEMC_API sc_core::sc_vpool<sc_concat_bool>;
#endif
