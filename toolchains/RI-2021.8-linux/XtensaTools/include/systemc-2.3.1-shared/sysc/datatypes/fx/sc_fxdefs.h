...
SYSTEMC_API const std::string to_string( sc_enc );
...
SYSTEMC_API const std::string to_string( sc_q_mode );
...
SYSTEMC_API const std::string to_string( sc_o_mode );
...
SYSTEMC_API const std::string to_string( sc_switch );
...
SYSTEMC_API const std::string to_string( sc_fmt );
