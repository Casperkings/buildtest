...
SYSTEMC_API void multiply( scfx_rep&, const scfx_rep&, const scfx_rep&, 
	       int max_wl = SC_DEFAULT_MAX_WL_ );
SYSTEMC_API scfx_rep*  neg_scfx_rep( const scfx_rep& );
SYSTEMC_API scfx_rep*  mult_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                  int max_wl = SC_DEFAULT_MAX_WL_ );
SYSTEMC_API scfx_rep*  div_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_DIV_WL_ );
SYSTEMC_API scfx_rep*  add_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_MAX_WL_ );
SYSTEMC_API scfx_rep*  sub_scfx_rep( const scfx_rep&, const scfx_rep&, 
	                 int max_wl = SC_DEFAULT_MAX_WL_ );
SYSTEMC_API scfx_rep*  lsh_scfx_rep( const scfx_rep&, int );
SYSTEMC_API scfx_rep*  rsh_scfx_rep( const scfx_rep&, int );
SYSTEMC_API int        cmp_scfx_rep( const scfx_rep&, const scfx_rep& );
...
public:
    ...
    friend SYSTEMC_API void multiply( scfx_rep&, const scfx_rep&, const scfx_rep&, int );

    friend SYSTEMC_API scfx_rep* neg_scfx_rep( const scfx_rep& );
    friend SYSTEMC_API scfx_rep* mult_scfx_rep( const scfx_rep&, const scfx_rep&, int );
    friend SYSTEMC_API scfx_rep* div_scfx_rep( const scfx_rep&, const scfx_rep&, int );
    friend SYSTEMC_API scfx_rep* add_scfx_rep( const scfx_rep&, const scfx_rep&, int );
    friend SYSTEMC_API scfx_rep* sub_scfx_rep( const scfx_rep&, const scfx_rep&, int );
    friend SYSTEMC_API scfx_rep* lsh_scfx_rep( const scfx_rep&, int );
    friend SYSTEMC_API scfx_rep* rsh_scfx_rep( const scfx_rep&, int );

    void lshift( int );
    void rshift( int );

    friend SYSTEMC_API int        cmp_scfx_rep( const scfx_rep&, const scfx_rep& );
    ...
    friend SYSTEMC_API scfx_rep* quantization_scfx_rep( const scfx_rep&,
					     const scfx_params&,
					     bool& );
    friend SYSTEMC_API scfx_rep*     overflow_scfx_rep( const scfx_rep&,
					     const scfx_params&,
					     bool& );
...
private:
    ...
    friend SYSTEMC_API void  align( const scfx_rep&, const scfx_rep&, int&, int&,
			scfx_mant_ref&, scfx_mant_ref& );
    friend SYSTEMC_API int   compare_msw( const scfx_rep&, const scfx_rep& );
    friend SYSTEMC_API int   compare_msw_ff( const scfx_rep& lhs, const scfx_rep& rhs );
    ...
    friend SYSTEMC_API void print_dec( scfx_string&, const scfx_rep&, int, sc_fmt );
    friend SYSTEMC_API void print_other( scfx_string&, const scfx_rep&, sc_numrep, int,
			     sc_fmt, const scfx_params* );

    void quantization( const scfx_params&, bool& );
    void     overflow( const scfx_params&, bool& );

    friend SYSTEMC_API int compare_abs( const scfx_rep&, const scfx_rep& );
