...
private:
    ...
    template class SYSTEMC_API sc_core::sc_phash_iter<const sc_core::sc_process_b*,const T*>;
    template class SYSTEMC_API sc_core::sc_phash     <const sc_core::sc_process_b*,const T*>;
#endif
