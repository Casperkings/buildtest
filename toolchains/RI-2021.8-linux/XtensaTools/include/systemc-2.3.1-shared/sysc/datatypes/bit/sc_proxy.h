...
// TODO:  Resolve disabling of warning C4661 in MSVC properties of scfx_rep.cpp  (due to include of sc_bv_base.h)
namespace sc_dt
{
...
SYSTEMC_API const std::string convert_to_bin( const char* s );
SYSTEMC_API const std::string convert_to_fmt( const std::string& s, sc_numrep numrep, bool );
