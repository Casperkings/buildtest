...
SYSTEMC_API const std::string to_string( sc_numrep );
...
is_valid_base(sc_numrep base)
{
 ...
 SC_PRAGMA_WARNING(disable:4996)
...
extern
SYSTEMC_API void parse_hex_bits( 
    const char* src_p, int dst_n, sc_digit* data_p, sc_digit* ctrl_p=0
);
