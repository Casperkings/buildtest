...
#ifdef SC_MAX_NBITS
extern SYSTEMC_API const int MAX_NDIGITS;
...
#   endif
    ...
    extern SYSTEMC_API const uint64        UINT64_ZERO;
    extern SYSTEMC_API const uint64        UINT64_ONE;
    extern SYSTEMC_API const uint64        UINT64_32ONES;
#endif
...
extern SYSTEMC_API const small_type NB_DEFAULT_BASE ;
...
extern SYSTEMC_API const uint64 UINT_ZERO;
extern SYSTEMC_API const uint64 UINT_ONE;
...
extern SYSTEMC_API const unsigned int UINT_ZERO;
extern SYSTEMC_API const unsigned int UINT_ONE;
