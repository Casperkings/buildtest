...
extern SYSTEMC_API const uint_type mask_int[SC_INTWIDTH][SC_INTWIDTH];
...
class SYSTEMC_API sc_uint_bitref_r : public sc_value_base
{
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_uint_bitref>;
#endif
...
class SYSTEMC_API sc_uint_bitref
...
class SYSTEMC_API sc_uint_subref_r : public sc_value_base
{
    friend class sc_uint_base;
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_uint_subref>;
#endif
...
class SYSTEMC_API sc_uint_subref
...
class SYSTEMC_API sc_uint_base : public sc_value_base
{
