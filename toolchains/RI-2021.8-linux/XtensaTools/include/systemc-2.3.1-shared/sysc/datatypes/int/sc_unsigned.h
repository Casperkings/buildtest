...
SYSTEMC_API int compare_unsigned(small_type us,
                              int unb,
                              int und,
                              const sc_digit *ud,
                              small_type vs,
...
SYSTEMC_API sc_unsigned add_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SYSTEMC_API sc_unsigned sub_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SYSTEMC_API sc_unsigned mul_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SYSTEMC_API sc_unsigned div_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SYSTEMC_API sc_unsigned mod_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
...
SYSTEMC_API sc_unsigned and_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
SYSTEMC_API sc_unsigned or_unsigned_friend(small_type us,
                                        int unb,
                                        int und,
                                        const sc_digit *ud,
                                        small_type vs,
...
SYSTEMC_API sc_unsigned xor_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
...
// friend operator declarations
  ...
  SYSTEMC_API   sc_signed operator + (const sc_unsigned&  u, const sc_signed&    v);
  SYSTEMC_API   sc_signed operator + (const sc_signed&    u, const sc_unsigned&  v);

  SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator + (const sc_unsigned&  u, int64               v);
  SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, uint64              v);
  SYSTEMC_API   sc_signed operator + (const sc_unsigned&  u, long                v);
  SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, unsigned long       v);
  SYSTEMC_API   sc_signed operator + (const sc_unsigned&  u, int                 v);
  inline sc_unsigned operator + (const sc_unsigned&  u, unsigned int        v);

  SYSTEMC_API   sc_signed operator + (int64               u, const sc_unsigned&  v);
  SYSTEMC_API sc_unsigned operator + (uint64              u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator + (long                u, const sc_unsigned&  v);
  SYSTEMC_API sc_unsigned operator + (unsigned long       u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator + (int                 u, const sc_unsigned&  v);
  inline sc_unsigned operator + (unsigned int        u, const sc_unsigned&  v);

  SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, const sc_uint_base& v);
  SYSTEMC_API   sc_signed operator + (const sc_unsigned&  u, const sc_int_base&  v);
  SYSTEMC_API sc_unsigned operator + (const sc_uint_base& u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator + (const sc_int_base&  u, const sc_unsigned&  v);
  ...
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, int64               v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, uint64              v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, long                v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, unsigned long       v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, int                 v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, unsigned int        v);

  SYSTEMC_API   sc_signed operator - (int64               u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (uint64              u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (long                u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (unsigned long       u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (int                 u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (unsigned int        u, const sc_unsigned&  v);

  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, const sc_uint_base& v);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned&  u, const sc_int_base&  v);
  SYSTEMC_API   sc_signed operator - (const sc_uint_base& u, const sc_unsigned&  v);
  SYSTEMC_API   sc_signed operator - (const sc_int_base&  u, const sc_unsigned&  v);
  ...
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_signed&    v);
  SYSTEMC_API   sc_signed operator << (const sc_signed&    u, const sc_unsigned&  v);

  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_unsigned&  v);
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, int64               v);
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, uint64              v);
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, long                v);
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, unsigned long       v);
  inline sc_unsigned operator << (const sc_unsigned&  u, int                 v);
  inline sc_unsigned operator << (const sc_unsigned&  u, unsigned int        v);

  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_uint_base& v);
  SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_int_base&  v);
  ...
  SYSTEMC_API sc_unsigned operator >> ( const sc_unsigned& , const sc_uint_base& );
  SYSTEMC_API sc_unsigned operator >> ( const sc_unsigned&, const sc_int_base& );

  // Unary arithmetic operators
  SYSTEMC_API sc_unsigned operator + (const sc_unsigned& u);
  SYSTEMC_API   sc_signed operator - (const sc_unsigned& u);

  // LOGICAL OPERATORS:

  // Logical EQUAL operators:

  SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_signed&    v);
  SYSTEMC_API bool operator == (const sc_signed&    u, const sc_unsigned&  v);

  SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_unsigned&  v);
  SYSTEMC_API bool operator == (const sc_unsigned&  u, int64               v);
  SYSTEMC_API bool operator == (const sc_unsigned&  u, uint64              v);
  SYSTEMC_API bool operator == (const sc_unsigned&  u, long                v);
  SYSTEMC_API bool operator == (const sc_unsigned&  u, unsigned long       v);
  inline bool operator == (const sc_unsigned&  u, int                 v);
  inline bool operator == (const sc_unsigned&  u, unsigned int        v);

  SYSTEMC_API bool operator == (int64               u, const sc_unsigned&  v);
  SYSTEMC_API bool operator == (uint64              u, const sc_unsigned&  v);
  SYSTEMC_API bool operator == (long                u, const sc_unsigned&  v);
  SYSTEMC_API bool operator == (unsigned long       u, const sc_unsigned&  v);
  inline bool operator == (int                 u, const sc_unsigned&  v);
  inline bool operator == (unsigned int        u, const sc_unsigned&  v) ;

  SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_uint_base& v);
  SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_int_base&  v);
  SYSTEMC_API bool operator == (const sc_uint_base& u, const sc_unsigned&  v);
  SYSTEMC_API bool operator == (const sc_int_base&  u, const sc_unsigned&  v);
...
class SYSTEMC_API sc_unsigned_bitref_r : public sc_value_base
{
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_unsigned_bitref>;
#endif
...
class SYSTEMC_API sc_unsigned_bitref
...
class SYSTEMC_API sc_unsigned_subref_r : public sc_value_base
{
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_unsigned_subref>;
#endif
...
class SYSTEMC_API sc_unsigned_subref
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_unsigned>;
#endif
...
class SYSTEMC_API sc_unsigned : public sc_value_base
{
...
#           endif
  ...
  friend   SYSTEMC_API sc_signed operator + (const sc_unsigned&  u, const sc_signed&    v);
  friend   SYSTEMC_API sc_signed operator + (const sc_signed&    u, const sc_unsigned&  v);

  friend SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator + (const sc_unsigned&  u, int64               v);
  friend SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, uint64              v);
  friend   SYSTEMC_API sc_signed operator + (const sc_unsigned&  u, long                v);
  friend SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, unsigned long       v);
  friend   SYSTEMC_API sc_signed operator + (const sc_unsigned&  u, int                 v);
  friend sc_unsigned operator + (const sc_unsigned&  u, unsigned int        v)
    { return operator+(u, (unsigned long) v); }

  friend   SYSTEMC_API sc_signed operator + (int64               u, const sc_unsigned&  v);
  friend SYSTEMC_API sc_unsigned operator + (uint64              u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator + (long                u, const sc_unsigned&  v);
  friend SYSTEMC_API sc_unsigned operator + (unsigned long       u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator + (int                 u, const sc_unsigned&  v);
  ...
  friend SYSTEMC_API sc_unsigned operator + (const sc_unsigned&  u, const sc_uint_base& v);
  friend   SYSTEMC_API sc_signed operator + (const sc_unsigned&  u, const sc_int_base&  v);
  friend SYSTEMC_API sc_unsigned operator + (const sc_uint_base& u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator + (const sc_int_base&  u, const sc_unsigned&  v);
  const sc_unsigned& operator += (const sc_int_base&  v);
  const sc_unsigned& operator += (const sc_uint_base& v);
  ...
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, int64               v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, uint64              v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, long                v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, unsigned long       v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, int                 v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, unsigned int        v);

  friend   SYSTEMC_API sc_signed operator - (int64               u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (uint64              u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (long                u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (unsigned long       u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (int                 u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (unsigned int        u, const sc_unsigned&  v);
  ...
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, const sc_uint_base& v);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned&  u, const sc_int_base&  v);
  friend   SYSTEMC_API sc_signed operator - (const sc_uint_base& u, const sc_unsigned&  v);
  friend   SYSTEMC_API sc_signed operator - (const sc_int_base&  u, const sc_unsigned&  v);
  const sc_unsigned& operator -= (const sc_int_base&  v);
  const sc_unsigned& operator -= (const sc_uint_base& v);
  ...
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_signed&    v);
  friend   SYSTEMC_API sc_signed operator << (const sc_signed&    u, const sc_unsigned&  v);

  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_unsigned&  v);
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, int64               v);
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, uint64              v);
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, long                v);
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, unsigned long       v);
  ...
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_uint_base& v);
  friend SYSTEMC_API sc_unsigned operator << (const sc_unsigned&  u, const sc_int_base&  v);
  const sc_unsigned& operator <<= (const sc_int_base&  v);
  const sc_unsigned& operator <<= (const sc_uint_base& v);
  ...
  friend SYSTEMC_API sc_unsigned operator >> ( const sc_unsigned& , const sc_uint_base& );
  friend SYSTEMC_API sc_unsigned operator >> ( const sc_unsigned&, const sc_int_base& );
  const sc_unsigned& operator >>= (const sc_int_base&  v);
  const sc_unsigned& operator >>= (const sc_uint_base& v);

  // Unary arithmetic operators
  friend SYSTEMC_API sc_unsigned operator + (const sc_unsigned& u);
  friend   SYSTEMC_API sc_signed operator - (const sc_unsigned& u);

  // LOGICAL OPERATORS:

  // Logical EQUAL operators:

  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_signed&    v);
  friend SYSTEMC_API bool operator == (const sc_signed&    u, const sc_unsigned&  v);

  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_unsigned&  v);
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, int64               v);
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, uint64              v);
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, long                v);
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, unsigned long       v);
  friend bool operator == (const sc_unsigned&  u, int                 v)
    { return operator==(u, (long) v); }
  friend bool operator == (const sc_unsigned&  u, unsigned int        v)
    { return operator==(u, (unsigned long) v); }

  friend SYSTEMC_API bool operator == (int64               u, const sc_unsigned&  v);
  friend SYSTEMC_API bool operator == (uint64              u, const sc_unsigned&  v);
  friend SYSTEMC_API bool operator == (long                u, const sc_unsigned&  v);
  friend SYSTEMC_API bool operator == (unsigned long       u, const sc_unsigned&  v);
  ...
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_uint_base& v);
  friend SYSTEMC_API bool operator == (const sc_unsigned&  u, const sc_int_base&  v);
  friend SYSTEMC_API bool operator == (const sc_uint_base& u, const sc_unsigned&  v);
  friend SYSTEMC_API bool operator == (const sc_int_base&  u, const sc_unsigned&  v);
  ...
  // Helper functions.
  friend SYSTEMC_API int compare_unsigned(small_type us,
                              int unb,
                              int und,
                              const sc_digit *ud,
                              small_type vs,
  ...
  friend SYSTEMC_API sc_unsigned add_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
  ...
  friend SYSTEMC_API sc_unsigned sub_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
  ...
  friend SYSTEMC_API sc_unsigned mul_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
  ...
  friend SYSTEMC_API sc_unsigned div_unsigned_friend(small_type s,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
  ...
  friend SYSTEMC_API sc_unsigned mod_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         int vnb,
  ...
  friend SYSTEMC_API sc_unsigned and_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
  ...
  friend SYSTEMC_API sc_unsigned or_unsigned_friend(small_type us,
                                        int unb,
                                        int und,
                                        const sc_digit *ud,
                                        small_type vs,
  ...
  friend SYSTEMC_API sc_unsigned xor_unsigned_friend(small_type us,
                                         int unb,
                                         int und,
                                         const sc_digit *ud,
                                         small_type vs,
