...
class SYSTEMC_API sc_int_bitref_r : public sc_value_base
{
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_int_bitref>;
#endif
...
class SYSTEMC_API sc_int_bitref
...
class SYSTEMC_API sc_int_subref_r : public sc_value_base
{
    friend class sc_int_base;
...
#ifdef _MSC_VER
template class SYSTEMC_API sc_core::sc_vpool<sc_int_subref>;
#endif
...
class SYSTEMC_API sc_int_subref
...
class SYSTEMC_API sc_int_base : public sc_value_base
{
