...
class XTSC_VP_API xtsc_tlm2pin_wire_transactor_vp_RESET : public xtsc::xtsc_tlm2pin_wire_transactor<1, bool> {
public:
...
class XTSC_VP_API xtsc_tlm2pin_wire_transactor_vp_CLOCK : public xtsc::xtsc_tlm2pin_wire_transactor<1, bool> {
public:
